...
/**
 * Map LSP severity to Neural Network Coder diagnostic severity
 *
 * Maps LSP severity numbers to Neural Network Coder diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to Neural Network Coder diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by Neural Network Coder's attachment system.
 */
 ...
 * from all LSP servers and routes them to Neural Network Coder's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to Neural Network Coder format (can throw on invalid URIs)
