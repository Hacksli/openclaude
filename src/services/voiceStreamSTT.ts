...
// OAuth credentials as Neural Network Coder.  The endpoint uses conversation_engine
...
export function isVoiceStreamAvailable(): boolean {
  // voice_stream uses the same OAuth as Neural Network Coder — available when the
  // user is authenticated with Anthropic (Neural Network Coder.ai subscriber or has
  // valid OAuth tokens).
