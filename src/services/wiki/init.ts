...
function buildSchemaTemplate(projectName: string): string {
  return `# Neural Network Wiki Schema
...
This wiki is maintained by Neural Network as a durable project knowledge layer.
...
- ${timestamp}: Wiki initialized by Neural Network
`
}
