...
function buildSchemaTemplate(projectName: string): string {
  return `# Neural Network Coder Wiki Schema
...
This wiki is maintained by Neural Network Coder as a durable project knowledge layer.
...
- ${timestamp}: Wiki initialized by Neural Network Coder
`
}
