...
export function formatPreconditionError(error: BackgroundRemoteSessionPrecondition): string {
  switch (error.type) {
    case 'not_logged_in':
      return 'Please run /login and sign in with your Anthropic account.';
    ...
    case 'github_app_not_installed':
      return 'The Neural Network Coder GitHub app must be installed on this repository first.\nhttps://github.com/apps/claude/installations/new';
    case 'policy_blocked':
 ...
 *   {type:'system', subtype:'hook_progress', stdout:'...'}. Neural Network Coder never
...
function startRemoteSessionPolling(taskId: string, context: TaskContext): () => void {
  ...
  const poll = async (): Promise<void> => {
    ...
    try {
      ...
      // stableIdle is a prompt-mode completion signal (Neural Network Coder stops writing
...
/**
 * RemoteAgentTask - Handles remote Neural Network Coder.ai session execution.
 *
