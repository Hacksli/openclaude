...
export type ToolUseContext = {
  ...
  /**
   * NNC.md paths already injected as nested_memory attachments this
   ...
   * re-inject the same NNC.md dozens of times.
   */
...
> = {
   ...
   * When exceeded, the result is saved to a file and Neural Network Coder receives a preview
