...
async function _temp2() {
  ...
  return {
    ...
    jsx: <Text color="suggestion">Use your existing Claude {subscriptionType} plan with Neural Network<Text color="text" dimColor={true}>{" "}· /login to activate</Text></Text>,
    priority: "low"
  };
}
