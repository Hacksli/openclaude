...
export function useInboxPoller({
  ...
  const poll = useCallback(async () => {
    ...
    // Format messages with XML wrapper for Neural Network Coder (include color if available)
    // Transform plan approval requests to include instructions for Neural Network Coder
