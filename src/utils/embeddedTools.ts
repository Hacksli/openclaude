 ...
 *
 * When true:
 * - `find` and `grep` in Neural Network Coder's Bash shell are shadowed by shell functions
 ...
 * - Prompt guidance steering Neural Network Coder away from find/grep is omitted
 *
