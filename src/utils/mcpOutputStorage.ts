...
/**
 * Generates instruction text for Neural Network Coder to read from a saved output file.
 *
...
/**
 * Build a short message telling Neural Network Coder where binary content was saved.
