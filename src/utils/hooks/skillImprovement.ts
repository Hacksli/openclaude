...
import { queryModelWithoutStreaming } from '../../services/api/messagesClient.js'
...
export async function applySkillImprovement(
  ...
  // Skills live at .nnc/skills/<name>/SKILL.md relative to CWD
  const filePath = join(getCwd(), '.nnc', 'skills', skillName, 'SKILL.md')
