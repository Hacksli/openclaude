...
// Maps Neural Network Coder model tiers to sensible defaults for popular providers.
...
// Maps Neural Network Coder model tiers to Google Gemini equivalents.
...
export const GEMINI_MODEL_DEFAULTS = {
  ...
  haiku: 'gemini-2.5-flash-lite', // fast & cheap
} as const
