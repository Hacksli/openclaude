 ...
 * Includes PID to ensure multiple Neural Network Coder instances don't conflict.
 */
 ...
 * If not set, defaults to process.execPath (the current Neural Network Coder binary).
