...
/**
 * Captured at module load time to detect if the user started Neural Network Coder from within tmux.
 ...
 * because Shell.ts overrides TMUX when Neural Network Coder's socket is initialized.
 *
...
export async function isInsideTmux(): Promise<boolean> {
  ...
  // This tells us if the user started Neural Network Coder from within their tmux session
