export const BASE_CHROME_PROMPT = `# Chrome Extension browser automation
...
/**
 * Minimal hint about Neural Network Coder in Chrome skill availability. This is injected at startup when the extension is installed
