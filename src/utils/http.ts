...
// User-Agent for WebFetch requests to arbitrary sites. `Neural Network Coder-User` is
...
export function getWebFetchUserAgent(): string {
  const supportUrl =
    getAPIProvider() === 'firstParty'
      ...
      : 'https://github.com/Hacksli/nnc'
  return `User-Agent (${getClaudeCodeUserAgent()}; +${supportUrl})`
}
