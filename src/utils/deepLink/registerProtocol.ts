...
const APP_NAME = 'Neural Network Coder URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Neural Network Coder URL Handler.app'
 ...
 * Neural Network Coder then uses the url-handler NAPI module to read the URL from the
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Neural Network Coder Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Neural Network Coder
