...
const APP_NAME = 'Neural Network URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Neural Network URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Neural Network Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Neural Network
