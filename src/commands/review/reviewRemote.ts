 ...
 * pushed branches on repos with the Neural Network Coder GitHub app installed.
 */
...
export async function launchRemoteReview(
  ...
  // shouldn't echo the same info. Just enough for Neural Network Coder to acknowledge the
