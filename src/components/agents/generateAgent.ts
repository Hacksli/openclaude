...
6 **Example agent descriptions**:
  ...
  - examples should be of the form:
    ...
    - <example>
      Context: User is creating an agent for Neural Network product questions.
      ...
      <commentary>
      Since the user is asking how to use Neural Network, use the claude-code-guide agent.
      </commentary>
    </example>
