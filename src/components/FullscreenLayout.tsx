 ...
 * users think of as "a new message from Neural Network Coder" — not raw assistant entries
 ...
 * until Neural Network Coder's text response lands.
 */
...
// conversation turn's prompt above the viewport so you know what Neural Network Coder was
