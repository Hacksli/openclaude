...
export function createWhatsNewFeed(releaseNotes: string[]): FeedConfig {
  ...
  return {
    title: "external" === 'ant' ? "Open Updates [internal-only: Latest CC commits]" : "Open Updates",
    lines,
...
export function createGuestPassesFeed(): FeedConfig {
  ...
  const subtitle = reward ? `Share and earn ${formatCreditAmount(reward)} of extra usage` : 'Share with friends';
  return {
