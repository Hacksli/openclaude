...
function isPathAllowed(
  ...
  // and internal editable paths live under ~/.nnc/ — matching the ordering in
...
function checkPathConstraintsForStatement(
  ...
  // Runtime writes /project/.nnc/settings.json (Neural Network Coder's permission config).
  //
      ...
      if (!allowed) {
        ...
        const message =
          ...
          decisionReason?.type === 'safetyCheck'
            ...
            : `${canonical} targeting '${resolvedPath}' was blocked. For security, Neural Network Coder may only access files in the allowed working directories for this session: ${dirListStr}.`
