/**
 * ProcessManager — spawns Neural Network Coder in print/SDK mode and manages the
...
class ProcessManager {
  /**
   * @param {object} opts
   * @param {string} opts.command - The nnc binary (e.g. 'nnc')
   ...
   */
  constructor(opts) {
    this._command = opts.command || 'nnc';
