...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/nnc.proto')
...
const nncProto = protoDescriptor.nnc.v1
...
async function main() {
  ...
  const client = new nncProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mNeural Network Coder gRPC CLI\x1b[0m')
